...
import '../social%20App%20screens/createcomment.dart';
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SocialCubite, SocialLayout>(
      ...
      builder: (context, state) {
        return SocialCubite.get(context).posts.isNotEmpty &&
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => CreateCommentScreen(
                        index: index,
                        postUser: model,
                        postId: SocialCubite.get(context).postid[index],
                      ),
                    ),
                  );
                },
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        InkWell(
                          onTap: () {
                            SocialCubite.get(context).likehost(
